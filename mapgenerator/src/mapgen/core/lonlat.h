...
inline Vector2 LonLat::operator-(const LonLat& other) const
{
    return Vector2(m_Lat - other.m_Lat, m_Lon - other.m_Lon);
}

inline LonLat& LonLat::operator+=(const Vector2& v)
{
    m_Lat += v.m_X;
    m_Lon += v.m_Y;
    return *this;
...
inline LonLat LonLat::operator+(const Vector2& v) const
{
    LonLat l(*this);
    l += v;
    return l;
